...
INSERT INTO species (family_id, name, abbreviation) VALUES ((SELECT id FROM families WHERE name = 'Leporidae'), 'Haas', 'HS') ON CONFLICT (name) DO NOTHING;
INSERT INTO species (family_id, name, abbreviation) VALUES ((SELECT id FROM families WHERE name = 'Leporidae'), 'Konijn', 'KN') ON CONFLICT (name) DO NOTHING;
