...
class Visit(TimestampMixin, SoftDeleteMixin, ArchivableMixin, Base):
    ...
    required_researchers: Mapped[int | None] = mapped_column(
    ...
    planned_date: Mapped[date | None] = mapped_column(
        "planned_date", nullable=True, index=True
    )
