...
from app.services.visit_status_service import resolve_visit_status
...
async def get_tight_visit_chains(db: AsyncSession, simulated_today: date | None = None) -> list[TightVisitResponse]:
    """
    ...
    from app.services.visit_status_service import _STATUS_ACTIONS, derive_visit_status, VisitStatusCode
        ...
        for i, (v, pvw) in enumerate(chain_items):
            ...
            if v.id in unique_tight_visits:
                ...
                visit_row = VisitListRow(
                    ...
                    functions=[FunctionCompactRead.model_validate(f) for f in v.functions],
