...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "contract",
            sa.Enum("Intern", "Flex", "ZZP", name="contract_type"),
            nullable=True,
        ),
        sa.Column(
            "experience_bat",
            sa.Enum("Nieuw", "Junior", "Medior", "Senior", name="experience_bat_type"),
            nullable=True,
        ),
        sa.Column("smp_huismus", sa.Boolean(), server_default="false", nullable=False),
        sa.Column(
            "smp_vleermuis", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column(
            "smp_gierzwaluw", sa.Boolean(), server_default="false", nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_activity_logs_batch_id"), "activity_logs", ["batch_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_availability_weeks_deleted_at"),
        "availability_weeks",
        ["deleted_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_availability_weeks_user_id"),
        "availability_weeks",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_clusters_cluster_number"), "clusters", ["cluster_number"], unique=False
    )
    op.create_index(
        op.f("ix_clusters_deleted_at"), "clusters", ["deleted_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_species_abbreviation"), "species", ["abbreviation"], unique=False
    )
    op.create_index(
        op.f("ix_species_family_id"), "species", ["family_id"], unique=False
    )
    op.create_index(op.f("ix_species_name"), "species", ["name"], unique=True)
    op.create_index(
        op.f("ix_species_name_latin"), "species", ["name_latin"], unique=True
    )
    op.create_table(
        "protocols",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.Column(
            "visit_duration_hours", sa.Numeric(precision=4, scale=1), nullable=True
        ),
        ...
        sa.Column(
            "requires_june_visit", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column(
        ...
        sa.Column(
            "requires_july_visit", sa.Boolean(), server_default="false", nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        op.f("ix_protocols_function_id"), "protocols", ["function_id"], unique=False
    )
    op.create_index(
        op.f("ix_protocols_species_id"), "protocols", ["species_id"], unique=False
    )
    op.create_table(
        "visits",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_visits_cluster_id"), "visits", ["cluster_id"], unique=False
    )
    op.create_index(
        op.f("ix_visits_deleted_at"), "visits", ["deleted_at"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_availability_weeks_user_id"), table_name="availability_weeks"
    )
    op.drop_index(
        op.f("ix_availability_weeks_deleted_at"), table_name="availability_weeks"
    )
