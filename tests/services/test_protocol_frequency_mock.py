...
async def test_lookback_frequency_exclusion(mocker):
    ...
    # Let's say:
    # - Protocol 10: Min gap 3 weeks. Last visited Week 19 (Start date 2026-05-08).
    # - Protocol 11: Min gap 1 week. Last visited Week 18 (Start date 2026-05-01).
    ...
    mock_result_candidates.scalars.return_value.unique.return_value.all.return_value = [
        cand_a,
        cand_b,
        cand_c,
    ]
