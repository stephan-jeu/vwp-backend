...
def test_calculate_duration_pure_absolute_time_crossing_midnight():
    ...
    duration, text, _ = calculate_visit_props([p1, p2], "Avond", reference_date=ref_date)
...
def test_calculate_duration_mixed_absolute_sunset_august():
    ...
    duration, text, _ = calculate_visit_props([p1, p2], "Avond", reference_date=ref_date_aug)
